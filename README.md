...
Install `github.com/lynara/rich-go`:

```
$ go get github.com/lynara/rich-go
```
...
```golang
import "github.com/lynara/rich-go/client"
```
...
1. Fork it (https://github.com/lynara/rich-go/fork)
